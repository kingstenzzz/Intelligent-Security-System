...
typedef struct {
    ...
    JSAMPLE *inbuf;//颜色转换,行扫描缓冲区
  	...
  	JC_STATE state;//状态变量
  	int  next_line; 
		FIL *fileW;//文件/////////////文件///////////文件///////////文件///////////文件///////////文件///////////文件//////////
} jpeg_compress_info;
...
void jpeg_set_default(jpeg_compress_info *cinfo,u8 *inbuf_buf);//设置默认参数 
...
void jpeg_calc_value(jpeg_compress_info *cinfo,u8 *inbuf_buf);//计算出一些有用的值并分配到缓冲区中
/////////////////写头信息函数组///////////////////////////////////////////////////
