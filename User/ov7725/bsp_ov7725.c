...
.cam_sx = (480-camera_WIDTH)/2,
	.cam_sy = (640-camera_HEIGHT)/2,	
	
	.cam_width = camera_WIDTH, 
	.cam_height = camera_HEIGHT, //在VGA模式下，此值才可以大于240
...
void camera_buff_save(u16 *camera_buf,u16 length, u16 width)
{
	u32 i;
	u16 camera_data;
